...
//   spam    — keywords repeated many times, zero information
//             TF-IDF ranks it very high (linear tf), BM25 less so (saturation), semantic ignores it
...
export const CHUNKS = [
  ...
  {
    id: 4, topic: "climate", type: "normal",
  ...
  {
    id: 6, topic: "climate", type: "synonym",
  ...
  {
    id: 10, topic: "space", type: "synonym",
...
export const QUERIES = [
  {
    ...
    relevant: [0, 1, 2], // spam (3) excluded from ground truth
  },
  {
    key: "climate",
    label: "Climate",
